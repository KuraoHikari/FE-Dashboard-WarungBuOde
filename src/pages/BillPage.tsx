...
import CreateBillFrom from "@/components/custom-form/create-bill-form";
                                ...
                                >
                                  ...
                                  <DialogContent className="sm:max-w-[825px]">
                                    <DialogHeader>
                                      <DialogTitle>
                                        Customer Name:{" "}
                                        {moreBillDetail.customerName}
                                      </DialogTitle>
                                      <div>
                                        <div>
                                          <p>
                                            Warung Name:{" "}
                                            {moreBillDetail.warung.name}
                                          </p>
